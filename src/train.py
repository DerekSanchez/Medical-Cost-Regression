...
def train_model(model_name, X_train, y_train, mode = 'manual', n_inter_random = 50):
    ...
    if mode == 'manual':
        ...
        for train_idx, val_idx in skf.split(X_train, y_train):
            # loop to separate train and validation set in traning
            # will be used to evalute score (eg accuracy) on train and validation
            # with this, we can evaluate overfit
